...
music_df.loc[(music_df['genre'] == 'avantgarde') & (music_df['total_play'] > 1000), 'total_play'] /= 10

# Проверим замену данных, выведем количество строк жанра avantgarde с длительностью > 1000:
count_avantgarde_over_1000 = music_df.query('genre == "avantgarde" and total_play > 1000').shape[0]
print(count_avantgarde_over_1000)
```
